...
6. [LED Color Organ trinket](https://learn.adafruit.com/trinket-sound-reactive-led-color-organ/preparing-to-code?view=all)
7. [Sounboard FX adafruit](https://learn.adafruit.com/adafruit-audio-fx-sound-board/powering-it?view=all)
8. [Thermal Light Painting](https://learn.adafruit.com/diy-flir-light-painting-heat-map-photography/arduino-code?view=all)
